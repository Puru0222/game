...
const FreeChallange = () => {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      console.error("Error Creating Free Fire challange:", error);
    } finally {
      setIsLoading(false);
    }
  };
        ...
        <div className="relative p-8 sm:p-10">
          <motion.div variants={itemVariants} className="text-center mb-8">
            ...
            <motion.p variants={itemVariants} className="text-gray-400">
              Create your custom battle room
            </motion.p>
          </motion.div>
          ...
          >
            ...
            >
              <AnimatedFormField delay={0.1}>
                ...
                <motion.input
                  ...
                  whileFocus="focus"
                  className="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800/50 text-orange-100 placeholder-gray-500 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
            ...
            >
              <AnimatedFormField delay={0.3}>
                ...
                <motion.select
                  variants={inputVariants}
                  whileFocus="focus"
                  className="w-full px-4 py-2 rounded-lg border border-gray-700 bg-gray-800/50 text-orange-100 focus:ring-2 focus:ring-orange-500 focus:border-transparent transition-all duration-200"
            ...
            <motion.button
              ...
              whileTap="tap"
              disabled={isLoading}
              className="w-full py-3 px-4 rounded-lg bg-gradient-to-r from-orange-600 to-orange-700 text-white font-medium hover:from-orange-700 hover:to-orange-800 transition-all duration-200 focus:ring-2 focus:ring-orange-500 focus:ring-offset-2 focus:ring-offset-gray-900 disabled:opacity-50"
              type="submit"
            >
              {isLoading ? (
